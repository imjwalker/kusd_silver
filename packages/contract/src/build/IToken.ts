...
export class Token {
  ...
  name(): token.str {
    ...
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.name': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
  ...
  symbol(): token.str {
    ...
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.symbol': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
      System.exit(callRes.code, StringBytes.stringToBytes(errorMessage));
    }
    if (!callRes.res.object) return new token.str();
    return Protobuf.decode<token.str>(callRes.res.object, token.str.decode);
  ...
  decimals(): token.uint32 {
    ...
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.decimals': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
      System.exit(callRes.code, StringBytes.stringToBytes(errorMessage));
    }
    if (!callRes.res.object) return new token.uint32();
    return Protobuf.decode<token.uint32>(callRes.res.object, token.uint32.decode);
  }
  ...
  get_info(): token.info {
    ...
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.get_info': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
      System.exit(callRes.code, StringBytes.stringToBytes(errorMessage));
    }
  ...
  allowance(args: token.allowance_args): token.uint64 {
    ...
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.allowance': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
      System.exit(callRes.code, StringBytes.stringToBytes(errorMessage));
    }
    if (!callRes.res.object) return new token.uint64();
    return Protobuf.decode<token.uint64>(callRes.res.object, token.uint64.decode);
  ...
  get_allowances(args: token.get_allowances_args): token.get_allowances_return {
    const argsBuffer = Protobuf.encode(args, token.get_allowances_args.encode);
    const callRes = System.call(this._contractId, 0x8fa16456, argsBuffer);
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.get_allowances': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
      System.exit(callRes.code, StringBytes.stringToBytes(errorMessage));
    }
    if (!callRes.res.object) return new token.get_allowances_return();
    return Protobuf.decode<token.get_allowances_return>(callRes.res.object, token.get_allowances_return.decode);
  }
  ...
  approve(args: token.approve_args): void {
    ...
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.approve': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
      System.exit(callRes.code, StringBytes.stringToBytes(errorMessage));
    }
    return;
  }
  ...
  mint(args: token.mint_args): void {
    ...
    if (callRes.code != 0) {
      const errorMessage = `failed to call 'Token.mint': ${callRes.res.error && callRes.res.error!.message ? callRes.res.error!.message : "unknown error"}`;
      System.exit(callRes.code, StringBytes.stringToBytes(errorMessage));
    }
    return;
  }
